...
%token
      ...
      '++'            { (TokenUnaryOp Increment, _) }
      '--'            { (TokenUnaryOp Decrement, _) }
      {- Binary operator(s. , _)-}
      '+'             { (TokenBinOp Plus, _) }
      '-'             { (TokenBinOp Minus, _) }
      '*'             { (TokenBinOp Mul, _) }
...
dcl  : 'extern' type some_id_parm_types         { Dcl Extern $2 (NonE.fromList $3) }
     ...
     | 'extern' type some_var_decl              { DclVar Extern $2 (NonE.fromList $3) }
     | type some_var_decl                       { DclVar Normal $1 (NonE.fromList $2) }

var_decl :: { VarDeclaration }
var_decl  : id '[' intcon ']'                   { Var $1 (Index (LitInt $3)) }
          | id                                  { Var $1 NotArray }
...
assg  : id '[' expr ']' '=' expr                { AssignId Nothing $1 (Index $3) $6 }
      | id '=' expr                             { AssignId Nothing $1 NotArray $3}
      | type id '=' expr                        { AssignId (Just $1) $2 NotArray $4}
      | '++' id                                 { PrefixInc $2 }
      | id '++'                                 { PostfixInc $1 }
      | '--' id                                 { PrefixDec $2 }
      | id '--'                                 { PostfixDec $1 }
...
-}
some_parm_type :: { [(Identifier, Type)] }
some_parm_type  : type id '[' ']' ',' some_parm_type  { ($2, (TypeArray $1)) : $6 }
                | type id '[' ']'                     { [($2, (TypeArray $1))] }
                | type id ',' some_parm_type          { ($2, $1) : $4 }
                | type id                             { [($2, $1)] }
